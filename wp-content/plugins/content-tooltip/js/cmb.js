...
(function($) {
	$(document).ready(function() {
		$(function() {
			if(parseInt(jQuery("#content_tooltip_options").length)==1 || parseInt(jQuery("#roundabout_slider_options").length)==1){
				jQuery(".misc-pub-section#visibility, #edit-slug-box, #preview-action").hide();
			}
		});
	});
})(jQuery);