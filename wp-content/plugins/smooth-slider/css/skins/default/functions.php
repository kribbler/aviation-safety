...
//2.1 changes end	
		...
		if ($smooth_slider['image_only'] == '1') { 
		   ...
		   if($permalink!='') {
			...
			$html .= '<span class="d_slider_content" '.$smooth_slider_css['smooth_slider_span'].'> '.$post_content.'</span>
...
/** begin custom function by daniel **/
function show_slide_title($post_id){
	$slide_title = get_post_custom_values('question_title', $post_id);
	$slide_title = $slide_title[0]; ?>
	<script type="text/javascript">
	jQuery(document).ready(function(){
		console.log('<?php echo $slide_title; ?>');
	});
	</script>
	<?php
}
/** end custom function by daniel **/
...
/* Changed fouc code end 2.6 */		
	...
	$html.='jQuery(document).ready(function() {
		console.log("here inside smooth slider code");
